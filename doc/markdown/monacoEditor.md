...
#### 设置options
例如取消小地图，更多的options设置请参考<a href='https://microsoft.github.io/monaco-editor/api/interfaces/monaco.editor.istandaloneeditorconstructionoptions.html'>monaco-editor官方文档</a>
```js
import {defineComponent} from 'san';
import {MonacoEditor} from 'monaco';
...
export default defineComponent({
    ...
    initData() {
        return {
            value: "SELECT * FROM Persons WHERE firstname='Thomas' OR lastname='Carter'",
            theme: 'hc-black',
            language: 'sql',
            height: 300,
            options: {
